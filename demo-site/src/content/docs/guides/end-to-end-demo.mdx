...
category: Guides
order: 1
capability: Full sequence
duration: 20 min
difficulty: Core
icon: book-open
summary: A curated 20-minute run through every major capability.
---
...
**Narrate:** _"Copilot code review examines code for correctness, security, and consistency — just like a senior engineer would."_
...
**Narrate:** _"Agent skills can produce artifacts like diagrams from natural language."_

...
order: 1
icon: play
summary: Set up Codespaces or a local environment in a couple of minutes.
---
...
- [GitHub Copilot CLI](https://docs.github.com/en/copilot/how-tos/copilot-cli/set-up-copilot-cli/install-copilot-cli) (for CLI demos)

## Launch the Environment

<Tabs label="Setup method">

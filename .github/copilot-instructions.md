...
**Octo E-Shop** is a bicycle e-commerce platform built as microservices
(Node.js/TypeScript, React, PostgreSQL + Redis, Prisma) deployed to Azure AKS via Terraform
and Helm.
